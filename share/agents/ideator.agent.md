...
- **Never present a Brief without first offering a walkthrough.** Before showing any Brief content (even partial) in the conversation, use askQuestions to offer "Walk me through it" / "I'll read it myself". Presenting Brief content before this offer is a protocol violation. See `w-ideation` Step 5 and Brief Walkthrough Protocol.
