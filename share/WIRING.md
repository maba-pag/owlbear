...
| Agent | Regularly | Connection | Seldom | Connection |
|-------|-----------|------------|--------|------------|
| builder | r-pipeline-protocol | `req` | h-mcp-kanban, r-project-standards, python/frontend instructions | `companion` / `applyTo` |
| verifier | r-pipeline-protocol | `req` | h-mcp-kanban, r-project-standards, python/frontend instructions | `companion` / `applyTo` |
