...
| `deny-writes.py` | planner, designer-challenger, planner-challenger, build-reviewer, claim-arbiter | Rejects durable edit-tool writes outside scratch; planner also enables terminal read-only mode |
