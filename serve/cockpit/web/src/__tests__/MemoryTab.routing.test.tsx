...
describe('MemoryTabFilterIntersection', () => {
  afterEach(() => {
    vi.unstubAllGlobals()
  })
...
describe('MemoryTabRowRendering', () => {
  afterEach(() => {
    vi.unstubAllGlobals()
  })
