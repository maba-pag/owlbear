...
function renderIdeasPage(element = <IdeasPage />) {
  const router = createMemoryRouter([{ path: "/ideas", element }], {
...
describe("IdeasPageIntegration_SaveFlow", () => {
  ...
  it("ac1 happy: PUT /api/ideas is called with the current textarea value in the request body", async () => {
    ...
    const body = JSON.parse(requirePresent(requestInit.body) as string) as {
      content: string;
    };
...
describe("IdeasPageIntegration_ScrollAffordance", () => {
  ...
  it("shows a subtle continuation cue when the markdown preview has more content below", async () => {
    ...
    Object.defineProperty(requirePresent(preview), "clientHeight", {
      configurable: true,
      value: 300,
    });
    Object.defineProperty(requirePresent(preview), "scrollTop", {
      configurable: true,
      value: 0,
    });
  ...
  it("tracks the native editor textarea as the active Ideas scroll surface", async () => {
    ...
    Object.defineProperty(requirePresent(textarea), "clientHeight", {
      configurable: true,
      value: 400,
    });
    Object.defineProperty(requirePresent(textarea), "scrollTop", {
      configurable: true,
      value: 0,
    });
...
describe("IdeasPageIntegration_SaveTimeConflict", () => {
      ...
      if (init?.method === "PUT") {
        ...
        if (body.force === true) {
          return Promise.resolve({
            ...
            status: 204,
            headers: new Headers({
              "x-ideas-updated-at": "2026-05-24T09:06:00+00:00",
            }),
            json: () => Promise.resolve(null),
          });
        }
  ...
  async function renderAfterSaveConflict(): Promise<{
