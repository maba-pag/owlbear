...
export const MARKDOWN_PREVIEW_CLASSNAME = [
  ...
  "[&_blockquote]:my-static-sm [&_blockquote]:border-l-4",
  "[&_blockquote]:border-contrast-low [&_blockquote]:pl-static-sm",
  ...
  "[&_pre]:my-static-sm [&_pre]:overflow-auto [&_pre]:rounded-md [&_pre]:border",
  "[&_pre]:border-contrast-low [&_pre]:bg-surface [&_pre]:p-static-sm [&_pre]:shadow-sm",
