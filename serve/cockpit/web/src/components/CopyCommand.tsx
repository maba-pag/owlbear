...
export default function CopyCommand({ command, className = '' }: CopyCommandProps) {
  ...
  return (
    <button
      type="button"
      className={[
        'relative z-[1] inline-flex max-w-full cursor-copy items-center gap-1 border-0 bg-transparent p-0 align-middle text-left text-[0.8125rem] leading-5 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus',
    ...
    >
      ...
      <code className="min-w-0 max-w-full break-all text-inherit leading-5">{command}</code>
