  ...
  const routeConfig = [
    {
      ...
      label: "Delivery",
      icon: "work",
      component: () => <main>Work portfolio</main>,
    },
    {
      path: "/memory",
      label: "Memory",
      icon: "memory",
      component: () => <main>Memory workspace</main>,
    },
    {
      path: "/ideas",
      label: "Ideas",
      icon: "ideas",
      component: () => <main>Ideas workspace</main>,
    },
  ];
  return {
    routeConfig,
    routeForPath: (pathname: string) =>
...
it("does not render a generic command footer", () => {
  ...
  expect(
    screen.queryByRole("button", {
      name: "Copy command /finalize-change <change-id>",
    }),
