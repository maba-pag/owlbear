...
class TestFromAC_FilesystemWalk:
    ...
    def test_excludes_files_nested_inside_excluded_dir(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_dir_name_prefix_match_is_not_excluded(
        self, tmp_path: Path
    ) -> None:
...
class TestFromAC_MarkdownFormat:
    ...
    def test_output_starts_with_auto_generated_header(
        self, tmp_path: Path
    ) -> None:
...
class TestFromAC_OutboundLinkExtraction:
    ...
    def test_links_in_fenced_code_block_not_extracted(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_link_in_indented_code_block_not_extracted(
        self, tmp_path: Path
    ) -> None:
...
class TestFromAC_DiagramDescribesField:
    ...
    def test_non_diagram_entry_has_no_describes_field(
        self, tmp_path: Path
    ) -> None:
...
class TestFromAC_ConditionalRegen:
    ...
    def test_regen_needed_when_index_does_not_exist(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_regen_needed_when_doc_is_newer_than_index(
        self, tmp_path: Path
    ) -> None:
