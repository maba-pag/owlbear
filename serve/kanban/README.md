...
`PortfolioApplication`; agent clients use the `owlbear-mcp-kanban` adapter documented in
[serve/mcp-kanban/README.md](../mcp-kanban/README.md). The adapter is the public tool and startup
