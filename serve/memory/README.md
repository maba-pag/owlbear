...
3. Validates the final UTF-8 Markdown representation is at most 8 192 bytes and round-trips
   unchanged through the canonical reader (raises an actionable `ValueError` before touching the
