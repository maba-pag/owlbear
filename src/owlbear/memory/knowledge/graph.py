...
tables created by :func:`owlbear.memory.knowledge.schema.init_db`.
...
from owlbear.memory.knowledge.models import Document, Edge, Entity
...
class GraphStore:
    ...
    def delete_entity(self, entity_id: str) -> bool:
        ...
        """
        # Cascade: remove edges referencing this entity.
        self._conn.execute(
    ...
    def insert_edge(self, edge: Edge) -> None:
        ...
        Foreign-key constraints enforce that *source_id* and *target_id*
        refer to existing entities.  Raises :class:`sqlite3.IntegrityError`
        on violation or duplicate id.
        """
        self._conn.execute(
            "INSERT INTO edges "
