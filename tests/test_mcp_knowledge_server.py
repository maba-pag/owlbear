...
- AC6: test_mcp_knowledge_legacy_removal.py B2b-retention assertions assert absence (not presence)
"""
...
from owlbear_knowledge_mcp.server import AppContext, refresh_knowledge_source as knowledge_sources_refresh
...
class TestSourceFetcherWiring:
    ...
    def test_legacy_removal_1900_b2b_tests_assert_absence_not_presence(self) -> None:
        """test_mcp_knowledge_legacy_removal.py must assert source_store/refresh_orchestrator absent (AC6)."""
        test_file = Path(__file__).parent / "test_mcp_knowledge_legacy_removal.py"
