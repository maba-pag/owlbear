...
AC coverage:
  - AC1: skills/task-verification/SKILL.md Step 3 updated with deduction rubric
...
_SKILL_FILE = _REPO_ROOT / "skills" / "task-verification" / "SKILL.md"
_AUDITOR_FILE = _REPO_ROOT / "agents" / "auditor.agent.md"
...
class TestFromAC_DeductionRubricPresent:
    ...
    def _step3_section(self) -> str:
        ...
        assert match is not None, (
            "## Step 3 section not found in skills/task-verification/SKILL.md"
        )
    ...
    def test_step3_has_deduction_rubric_heading_or_keyword(self) -> None:
        ...
        assert found, (
            "Step 3 in skills/task-verification/SKILL.md has no mention of 'deduct' or "
...
class TestFromAC_DeductionCriteriaValues:
    ...
    def test_deduction_minus_02_for_ac_line_no_evidence(self) -> None:
        ...
        assert pattern.search(text), (
            ...
            "not found in skills/task-verification/SKILL.md (AC2)"
        )
