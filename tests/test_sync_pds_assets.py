"""Tests for the PDS asset sync script (serve/cockpit/web/scripts/sync-pds-assets.mjs).

Verifies script existence, ESM validity, output file counts, error handling,
and end-to-end execution in an isolated workspace.
"""
