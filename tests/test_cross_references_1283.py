...
class TestFromAC_ApplyToExtension:
    ...
    def test_agent_ecosystem_instructions_apply_to_yaml_field_contains_owlbear_paths(
        self, project_root: Path
    ) -> None:
    ...
    def test_readme_stubs_row_mirrors_all_owlbear_paths(
        self, project_root: Path
    ) -> None:
    ...
    def test_h_agent_structure_stubs_row_mirrors_all_owlbear_paths(
        self, project_root: Path
    ) -> None:
    ...
    def test_wiring_table2_row_abbreviates_owlbear_agents_glob(
        self, project_root: Path
    ) -> None:
    ...
    def test_wiring_gap_analysis_row_mentions_owlbear_ecosystem_scope(
        self, project_root: Path
    ) -> None:
