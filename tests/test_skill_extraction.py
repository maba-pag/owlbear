...
class TestProjectInstructionAuthorityBoundary:
    ...
    def test_r_project_standards_owns_owlbear_file_placement(self) -> None:
        """Shared standards own placement for OwlBear-managed artifacts."""
        ...
        assert _FILE_PLACEMENT_HEADING in content
    ...
    def test_project_orientation_owns_discovery_tools(self) -> None:
        """The shared orientation handbook owns portable discovery behavior."""
        skill_file = _SKILLS_ROOT / "h-project-orientation" / "SKILL.md"
        content = skill_file.read_text(encoding="utf-8")
