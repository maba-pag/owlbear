...
class TestFromAC_FrozenDispatchContext:
    ...
    def test_mutating_task_id_raises(self) -> None:
        ...
        ctx = DispatchContext(
            workspace_root="/project", channel_name="slack", task_id="959"
        )
        with pytest.raises(dataclasses.FrozenInstanceError):
    ...
    def test_mutating_task_status_raises(self) -> None:
        ...
        ctx = DispatchContext(
            workspace_root="/project", channel_name="slack", task_status="todo"
        )
        with pytest.raises(dataclasses.FrozenInstanceError):
    ...
    def test_equal_instances_have_equal_hashes(self) -> None:
        ...
        ctx_a = DispatchContext(
            workspace_root="/project", channel_name="slack", task_id="1"
        )
