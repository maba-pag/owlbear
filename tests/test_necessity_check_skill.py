...
Verifies that:
- skills/code-review/SKILL.md gains a "### 6.6 Necessity check" section
...
SKILL_FILE = Path(__file__).parent.parent / "skills" / "code-review" / "SKILL.md"
REVIEWER_AGENT_FILE = Path(__file__).parent.parent / "agents" / "reviewer.agent.md"
...
class TestFromAC_NecessityCheckSection:
    """Tests for AC line 1: skills/code-review/SKILL.md must gain ### 6.6 Necessity check."""
