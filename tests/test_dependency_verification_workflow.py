# Maintained regression suite: do not delete as transient proof during test curation.
# Update these tests when the dependency-verification workflow contract changes.
