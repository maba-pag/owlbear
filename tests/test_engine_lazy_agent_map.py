...
class TestFromAC_PickTasksValidatesAgentMap:
    ...
    def test_pick_tasks_raises_config_error_for_empty_agent_map(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_pick_tasks_raises_config_error_for_partial_agent_map(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_pick_tasks_error_message_names_missing_statuses(
        self, tmp_path: Path
    ) -> None:
...
class TestFromAC_McpPickTasksRaisesForIncompleteAgentMap:
    ...
    @pytest.mark.asyncio
    async def test_mcp_pick_tasks_raises_tool_error_for_incomplete_agent_map(
        self, tmp_path: Path
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_mcp_pick_tasks_tool_error_message_contains_missing_entries(
        self, tmp_path: Path
    ) -> None:
