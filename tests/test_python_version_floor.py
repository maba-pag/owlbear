...
_SYNCED_PACKAGES: dict[str, pathlib.Path] = {
    ...
    "delivery": _ROOT / "serve/delivery/pyproject.toml",
    "knowledge": _ROOT / "serve/knowledge/pyproject.toml",
    "browser-mcp": _ROOT / "serve/browser-mcp/pyproject.toml",
    "delivery-mcp": _ROOT / "serve/delivery-mcp/pyproject.toml",
    "knowledge-mcp": _ROOT / "serve/knowledge-mcp/pyproject.toml",
    "memory-mcp": _ROOT / "serve/memory-mcp/pyproject.toml",
...
_SYNCED_SOURCES: dict[str, pathlib.Path] = {
    ...
    "delivery": _ROOT / "serve/delivery/src/owlbear_delivery",
    "knowledge": _ROOT / "serve/knowledge/src/owlbear_knowledge",
    "browser-mcp": _ROOT / "serve/browser-mcp/src/owlbear_browser_mcp",
    "delivery-mcp": _ROOT / "serve/delivery-mcp/src/owlbear_delivery_mcp",
    "knowledge-mcp": _ROOT / "serve/knowledge-mcp/src/owlbear_knowledge_mcp",
    "memory-mcp": _ROOT / "serve/memory-mcp/src/owlbear_memory_mcp",
