...
- Fix applied: replaced _reload_without_logfire() helper with _import_without_logfire() using patch.dict + sys.modules.pop('owlbear.daemon') + importlib.import_module().
