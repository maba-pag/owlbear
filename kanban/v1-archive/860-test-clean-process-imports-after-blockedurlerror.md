...
## AC
- [ ] In tests/test_daemon_journal_async.py, remove the import owlbear.tools pre-seeding workaround and keep direct from owlbear.daemon import _log_to_journal
