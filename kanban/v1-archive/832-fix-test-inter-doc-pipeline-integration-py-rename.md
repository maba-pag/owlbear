...
- IngestPipeline.__init__ (ingest.py L91) already refactored: inter_doc_builder -> enricher param, _inter_doc_builder -> _enricher attr
- GraphEnricher.__init__ (enrichment.py L55) still uses inter_doc_builder param  that's a DIFFERENT class, not in scope
