...
tags:
    ...
    - scope:core
blocked: true
block_reason: 'TestClassifyErrorWithoutOpenai uses importlib.reload() creating new ErrorCategory enum class, poisoning is-identity checks in test_error_recovery.py (8 cross-file failures). Fix: subprocess isolation or == comparisons.'
class: standard
---
