...
updated: 2026-03-17T21:38:20.4353171+01:00
...
depends_on:
    - 842
blocked: true
block_reason: 2 tests in test_content_safety_integration.py (TestFromACWebReadWrapping::test_wraps_return_value, test_skips_wrapping_when_disabled) still mock owlbear.tools.web_search.trafilatura which was removed by the migration. Update mocks to use extract_content.
class: standard
---
