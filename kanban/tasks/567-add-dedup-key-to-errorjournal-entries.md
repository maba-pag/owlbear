...
Research complete: See docs/error-journal-dedup-research.md. Recommendation: hash-based dedup_key (sha256[:16] of error_type+tool_name+exc_message) with 60s in-memory time-windowed cache. Confidence .80.
