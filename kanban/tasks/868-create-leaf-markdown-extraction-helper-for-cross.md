...
updated: 2026-03-23T06:41:52.3030343+01:00
...
- src/owlbear/web_extract.py satisfies leaf-module shape and AC call contract:
  - __all__ export at src/owlbear/web_extract.py:9
...
|---------|----------|--------|
| 1. Leaf export + no forbidden imports | web_extract.py:8-9 __all__; AST guard test at test_web_extract.py:320 | PASS |
