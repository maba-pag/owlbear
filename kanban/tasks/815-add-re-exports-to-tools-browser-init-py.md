...
updated: 2026-03-16T14:43:43.8021674+01:00
...
depends_on:
    - 813
blocked: true
block_reason: 'Won''t-do: YAGNI. 0/167 browser imports use package-level paths. Decision approved at docs/decisions/pending/813-re-export-feature-gate.md (Option A).'
class: standard
---
