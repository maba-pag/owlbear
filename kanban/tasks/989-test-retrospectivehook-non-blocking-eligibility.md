...
updated: 2026-03-24T14:28:27.4781117+01:00
...
| AC2(d) create_task: __call__ does not call _count_rejections | test_call_does_not_invoke_count_rejections_directly_create_task_path | boundary |

| AC2(d) create_task: background coro calls _count_rejections | test_create_task_fallback_background_coro_invokes_count_rejections | boundary |
...
- Retry reason: reviewer FAIL cited MISSING tests — AC2(d) create_task path never tested _get_priority timing/invocation
