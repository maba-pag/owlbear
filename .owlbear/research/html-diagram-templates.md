...
| OwlBear visual-explainer.md | Local `docs/research/visual-explainer.md` | Prior research recommending 2-3 templates, aesthetic constraints, YAGNI assessment | .85 — prior decision |
