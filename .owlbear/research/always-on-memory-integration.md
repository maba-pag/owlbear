...
| S4 | OwlBear KnowledgeQueryService research | `docs/research/context-aware-knowledge-injection.md` | 0.90 |
| S5 | OwlBear MemoryConsolidator research | `docs/research/memory-consolidator.md` | 0.95 — consolidation was deleted as YAGNI |
| S6 | OwlBear session-memory-hook research | `docs/research/session-memory-hook.md` | 0.85 |
| S7 | OwlBear temporal memory research | `docs/research/temporal-memory.md` | 0.80 — decay scoring pattern |
