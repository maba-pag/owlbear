...
| OwlBear daemon-bootstrap research | `docs/research/daemon-bootstrap.md` | .75 | Planned `DevToolset` with `file_read`, `file_write`, `list_directory` — confirms this task's scope |
