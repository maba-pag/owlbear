...
| 8 | OwlBear planner research | `docs/research/planner-agent.md` | .95 — WAVE_PLAN output contract, tool set, scope filter design |
| 9 | OwlBear evaluator research | `docs/research/evaluator-agent.md` | .95 — EvalResult output contract, verdict routing, retry hints |
