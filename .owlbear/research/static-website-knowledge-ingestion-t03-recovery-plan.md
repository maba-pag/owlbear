...
| `.owlbear/delivery/runtime/claims/changes/static-website-knowledge-ingestion.json` | Recovery restored the branch to `9612e7c6` and released writer custody while retaining reviewed authority. | The coordination record may drift before implementation begins. |
