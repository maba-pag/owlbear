...
| PinchTab SKILL.md token cost guide | `docs/research/pinchtab.md` S3c | Internal — token cost model | .85 |
| OwlBear BrowserToolset (toolset.py) | `src/owlbear/tools/browser/toolset.py` | Internal — existing pattern | .95 |
| OwlBear a11y-snapshot research (#726) | `docs/research/a11y-snapshot.md` | Internal — upstream API design | .90 |
