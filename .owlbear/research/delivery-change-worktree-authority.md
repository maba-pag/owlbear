...
| `adopt_external_head(change_id, expected_head, adopted_head, operation_id)` | exact descendant head from user/automation | Validates and records exact head | adoption receipt / publication attention |
