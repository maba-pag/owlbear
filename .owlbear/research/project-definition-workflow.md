...
| OwlBear conversation-router-research | `docs/research/conversation-router.md` | .85 | Intent taxonomy: "I have an idea" → `planner` agent via orchestrator routing |
| OwlBear pydantic-ai-multi-agent-research | `docs/research/pydantic-ai-multi-agent.md` | .80 | Structured output for delegation: `output_type=TaskResult` pattern |
