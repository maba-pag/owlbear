...
**Rationale:** Mission-critical capability. The knowledge DB's quality determines whether OwlBear can produce work that meets corporate standards. All domain voices, extended research, full depth.
...
URL allowlist enforcement at tool implementation level, not via HookRegistry hooks (which swallow exceptions). Non-negotiable per security-voice finding.
