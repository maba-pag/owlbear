...
updated: 2026-05-23T16:20:22+0200
tags:
  - cockpit-perfect-ui
  - scope:cockpit-web
  - ux-feedback
...
depends_on: [1758]
ac:
  - On mobile, the Ideas dirty preview toolbar shows the unsaved badge, Edit action, and Save action without clipping.
  ...
  - Screenshot and geometry metrics prove the dirty preview toolbar fits after the fix.
proof_bundle: smoke
blocked: false
block_reason:
claimed_at:
