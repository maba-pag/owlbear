...
tags:
  ...
  - visual-sweep
parent:
depends_on: [1741, 1742]
ac:
  - Capture current desktop screenshots for Kanban, Decisions, Memory, and Ideas after the task-detail and memory edit-action fixes.
  - Record geometry metrics for workspace bounding, overflow, scroll surfaces, and obvious action reachability.
