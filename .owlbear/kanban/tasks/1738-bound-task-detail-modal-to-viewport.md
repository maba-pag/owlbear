...
updated: 2026-05-23T10:09:05+0200
tags:
  - cockpit-perfect-ui
  - scope:cockpit-web
  - ux-feedback
...
depends_on: []
ac:
  - Reproduce the task detail window extending below the desktop viewport in the #1737 interaction sweep.
  - Keep task detail content fully reachable inside the modal without expanding the document.
  - Preserve existing task detail display/edit actions and unsaved-change behavior.
  - Add or update focused tests for the modal viewport bounds contract where practical.
