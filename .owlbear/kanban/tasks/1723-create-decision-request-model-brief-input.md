...
updated: 2026-05-23T02:07:23+0200
tags:
  - cockpit-perfect-ui
  - scope:briefs
  - ux-feedback
...
ac:
  ...
  - Create an ideation input file under `.owlbear/briefs/` for expanding the decision request data model, engine interface, and MCP interface.
  - Include decision vs action distinction, request IDs, full timestamp with timezone, structured options, confidence, response modes, and agent usability needs.
  - Keep the file usable as input for a later brief rather than presenting it as the final architecture.
proof_bundle: skip
blocked: false
block_reason:
claimed_at:
