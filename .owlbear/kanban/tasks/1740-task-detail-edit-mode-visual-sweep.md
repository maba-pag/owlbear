...
depends_on: [1739]
ac:
  - Capture current screenshots for task detail edit mode after the #1738/#1739 modal changes.
  - Include normal edit mode and dirty/unsaved-change state where possible.
  - Record metrics for viewport fit, scroll reachability, control visibility, and document overflow.
