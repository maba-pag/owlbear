...
updated: 2026-05-23T11:19:10+0200
tags:
  - cockpit-perfect-ui
  - scope:cockpit-web
  - ux-feedback
...
depends_on: [1748]
ac:
  - Use the #1748 mobile Ideas dirty-editor screenshot and metrics as current evidence.
  - Keep the Ideas editor toolbar actions visible and reachable on a 390x844 mobile viewport after entering dirty edit mode.
  - Prevent the native textarea from forcing its hidden editor shell to scroll or clip the toolbar on narrow viewports.
  - Preserve desktop Ideas editor sizing, dirty-state behavior, save/preview actions, and the #1747 scroll cue behavior.
  - Add or update focused tests for the mobile editor sizing/action visibility contract where practical.
