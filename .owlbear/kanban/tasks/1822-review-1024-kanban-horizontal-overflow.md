...
depends_on: []
ac:
  - The 1024px Kanban board screenshot is reviewed for whether horizontal column overflow is acceptable or harms usability.
  - If a layout change is needed, the tradeoff between column density, horizontal scrolling, and sidecar/rail space is decided before implementation.
