...
depends_on:
  - 1770
ac:
  - Current Cockpit screenshots cover representative opened panels, dialogs, dirty/edit states, and global header menus after the Canvas header fix.
  - The sweep checks 320px, 390px, and desktop widths where practical for viewport clipping, horizontal shift, hidden actions, and overlapping shell chrome.
