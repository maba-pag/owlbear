...
updated: 2026-05-23T02:57:06+0200
tags:
  - cockpit-perfect-ui
  - scope:cockpit-web
  - ux-feedback
...
depends_on: []
ac:
  - Reproduce the Memory tab list showing a raw `*` agent/audience value in visible item metadata.
  - Replace wildcard display with a human-readable label that preserves the underlying meaning.
  - Ensure filtering and expanded detail behavior still expose the correct structured value where needed.
