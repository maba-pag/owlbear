...
updated: 2026-05-23T11:03:10+0200
tags:
  - cockpit-perfect-ui
  - scope:cockpit-web
  - ux-feedback
...
depends_on: [1744]
ac:
  - Capture current desktop runtime evidence for at least the Decisions resolver and Ideas dirty/edit states after the #1744 Kanban affordance fix.
  - Record geometry metrics for visible action reachability, bounded scroll surfaces, document overflow, and console/page errors.
  - Classify each finding as observed/theoretical, current/future harm, and product value.
