...
updated: 2026-05-24T00:21:24+02:00
tags:
  - cockpit-perfect-ui
  - scope:cockpit-web
  - mobile
...
depends_on:
  - 1771
ac:
  - At 320px and 390px widths, the task detail edit modal gives editable fields enough horizontal room for tags, Add tag, Save, and Cancel controls to read as intentional.
  - The edit action bar remains reachable without visually burying the Add tag row or cramped tags area.
  - Desktop task detail modal width and scroll behavior remain unchanged in intent.
  - Focused screenshots and geometry metrics prove the fix with no console errors, failed requests, horizontal overflow, or Canvas root scroll regression.
  - The #1771 interaction-state sweep is updated after the fix.
proof_bundle: smoke
blocked: false
block_reason:
claimed_at:
