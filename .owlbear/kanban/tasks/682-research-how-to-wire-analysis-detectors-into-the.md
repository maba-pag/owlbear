...
| AC4: Follow-up tasks | MET | #692 (doc CLI in w-orchestration, status:research) and #693 (validate utility, status:research) — both verified to exist with concrete AC |
...
| AC4: Follow-up tasks created | #692 (doc CLI, status:review, concrete AC) and #693 (validate utility, status:in-progress, concrete AC) -- both verified with source:research-682 tag | PASS |
