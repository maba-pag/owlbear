...
ac:
  ...
  - The dual-theme accessibility sweep no longer waits on stale `[data-testid="move-backward"]` selectors.
  - Any repair stays harness-scoped unless current product behavior is proven wrong.
proof_bundle: smoke
blocked: false
block_reason:
claimed_at:
