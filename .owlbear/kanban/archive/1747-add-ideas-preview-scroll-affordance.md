...
ac:
  - Use the
  - Show a subtle continuation affordance when the Ideas preview or editor has
    more vertical content below the visible surface.
  - Hide the affordance when the scroll surface reaches the bottom or has no
    vertical overflow.
  - Preserve the bounded Ideas workspace, mobile state panel, save/preview
    actions, and no document-level overflow.
  - Add or update focused tests for the Ideas scroll-affordance contract where
    practical.
