...
updated: 2026-05-24T10:50:02.855499+02:00
tags:
  - scope:kanban-engine
  - test-failure
  - discussion
...
depends_on:
  - 1814
ac:
  - The three `tests/test_engine_validation_push.py` failures are traced to
    current predicate-validation behavior.
  - The intended owner of status predicate enforcement is confirmed before code
    changes.
