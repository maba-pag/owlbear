...
- **6 files**: models.py, schema.py, __init__.py, document_store.py, graph_store.py, test_remove_crawl_stubs_703.py
...
| SourcePage model + PageStatus enum | 20 | TestFromAC_PageStatus (9), TestFromAC_SourcePageModel (10), TestFromAC_SourcePageExport (4 including __all__ checks) |
...
- AssertionError: delete_source_cascade method absent, __all__ missing entries, schema_version == 8 not 9
...
| SourcePage + PageStatus exported | __init__.py:L11–12, L30, L38 | TestFromAC_SourcePageExport | PASS |
...
| SourcePage + PageStatus exported | __init__.py:L13 import + L43–44 in `__all__` | TestFromAC_SourcePageExport | PASS |
...
| SourcePage + PageStatus exported | __init__.py:L11 import, L37+L45 in `__all__` | PASS |
...
| 42bf5af0 | feat | models.py, schema.py, __init__.py, document_store.py, graph_store.py, test_remove_crawl_stubs_703.py | #757 |