...
depends_on: []
ac:
  - Audit markdown preview surfaces for missing numbered list markers and
    collapsed paragraph spacing.
  - Apply one shared markdown preview style to task detail/body edit preview,
    decision full request, ideas preview, and memory content where applicable.
