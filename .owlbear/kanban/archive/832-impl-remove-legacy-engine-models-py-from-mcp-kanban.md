...
### Coverage
owlbear_mcp_kanban overall: 41% (server.py 36%, models.py 88%, __init__.py 100%). No deduction — zero production files were touched (deletion task; pre-existing coverage state).
