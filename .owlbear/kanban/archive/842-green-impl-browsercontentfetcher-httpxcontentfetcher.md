...
### Lint
- `ruff check` on all 4 target files — **clean**
...
### Test Results
- pytest: **21 passed, 0 failed** (test_contentfetcher_impl_842.py: 2/2 + test_contentfetcher_impl_830.py: 19/19)
...
### Coverage
- `owlbear_browser.fetcher`: **100%** (13/13 stmts)
- `owlbear_knowledge.fetcher`: **100%** (8/8 stmts)
- `owlbear_browser.__init__`: **100%** (8/8 stmts)
