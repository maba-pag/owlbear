...
| Extract _ssrf.py with _is_blocked_ip + safe_async_fetch | 9 TestFromAC_SsrfUtility tests |
...
| AC7: _ssrf.py extraction | _ssrf.py exists with _is_blocked_ip + safe_async_fetch; intake.py delegates | PASS |
