...
All 23 tests fail: TypeError: RefreshOrchestrator.__init__() got an unexpected keyword argument 'inter_doc_builder'
[[2026-04-15]]
## Builder Notes
...
- noqa suppressions: PLR0913 (6 DI params on __init__), BLE001 (background exception logging), TRY400 (test checks `.error` not `.exception`), RUF006 (fire-and-forget task is valid with internal exception handling)
