...
| AC3: BoardConfig no longer exposes forwarding properties | TestFromAC_CompatLayerRemoval | Yes. Direct BoardConfig.__dict__ checks at tests/test_support_migration_1175.py:682-778 fail if any forwarding property remains. Current BoardConfig keeps only status_names as a property at models.py:395-398. | COVERED |
...
| AC3: BoardConfig no forwarding properties | tests/test_support_migration_1175.py:682-778 — __dict__ property assertions | PASS |
