...
- **Exclude dirs**: Comprehensive frozenset (11 entries: .venv, venv, __pycache__, .git, .tox, .mypy_cache, .pytest_cache, .ruff_cache, node_modules, dist, build, site-packages)
