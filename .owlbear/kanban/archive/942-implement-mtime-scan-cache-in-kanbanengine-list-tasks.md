...
41% on full engine module is expected — test file scopes to new cache code only (list_tasks, __init__, refresh_config). Other engine methods are covered by pre-existing test suite.
