...
### Architecture Notes
- Trivial two-kwarg threading. cancel already flows into _ingest_from_intake (ingest.py:252) and is used at _run_extract (line 269). This extends the same pattern to the enricher calls.
