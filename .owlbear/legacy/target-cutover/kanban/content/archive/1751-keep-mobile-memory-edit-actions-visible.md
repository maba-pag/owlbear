...
ac:
  - Use the
  - Keep Memory edit Save and Cancel visible and reachable on a 390x844 mobile
    viewport after entering edit mode.
  - Avoid mutating memory data during the visual proof.
  - Preserve the bounded Memory workspace, list scroll shell, desktop sticky
    edit header behavior, and no document-level overflow.
  - Add or update focused tests for the Memory edit positioning/action
    visibility contract where practical.
