...
The consumer branch intentionally excludes the dev-only `.github/` automation tree and
`.mega-linter.yml`; those remain on `dev` and are not part of the generated product surface.
