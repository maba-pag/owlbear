"""Verify exact Ruff version parity across repository tooling and MegaLinter."""
...
def check_ruff_toolchain(
    ...
    *,
    ...
    bundled_version = _read_ruff_command_version(
        [
            docker_executable,
            "run",
            "--rm",
    ...
    versions = {
        ...
        "MegaLinter bundled Ruff": bundled_version,
    }
