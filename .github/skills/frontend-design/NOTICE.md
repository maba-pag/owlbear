...
The `frontend-design` skill is an OwlBear-authored adaptation of upstream
design guidance. The original sources are:

| Source | Author | License | What was adapted |
|--------|--------|---------|-----------------|
| [Impeccable](https://github.com/paulbakaus/impeccable) — `source/skills/frontend-design/` | Paul Bakaus | Apache 2.0 | Reference pack structure, context-gathering flow, anti-pattern catalog, and attribution model |
| [Anthropic skills](https://github.com/anthropics/anthropic-cookbook) — `skills/frontend-design/SKILL.md` | Anthropic | MIT | Broad design-thinking workflow and skill framing |
...
No file in this skill package is a verbatim copy of either source.
