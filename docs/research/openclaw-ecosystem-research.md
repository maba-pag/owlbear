...
| OwlBear agent-patterns-research | docs/agent-patterns-research.md | .90 — prior art baseline |
| OwlBear openclaw-skills-research | docs/openclaw-skills-research.md | .90 — child #590 findings |
| OwlBear clawfeed-research | docs/clawfeed-research.md | .75 — child #591 findings |
