...
| OwlBear agent-framework.md | Definition, registry, delegation (#128-130) | 1.0 | (prior) |
| OwlBear agent-patterns.md | OpenClaw, Nanobot, Disler patterns (#22) | .95 | (prior) |
