...
| OwlBear openclaw-ecosystem-research.md | docs/openclaw-ecosystem-research.md | .85 — prior condenser/session research |
| OwlBear context-condenser-research.md | docs/context-condenser-research.md | .90 — existing condenser design |
