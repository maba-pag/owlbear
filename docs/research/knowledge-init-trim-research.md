...
```
kanban\kanban-md.exe create "Trim knowledge __init__.py to 14 public exports" --priority nice-to-have --tags "audit,architecture,knowledge" --status todo --description "Remove 21 implementation-detail symbols from __all__. Keep 14 public exports per docs/knowledge-init-trim-research.md. Update bootstrap.py L291 to import TextChunker from .chunker. Run full test suite to verify no breakage."
