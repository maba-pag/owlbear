...
| OwlBear dual-embedding-rrf-research | docs/dual-embedding-rrf-research.md | .90 | sqlite-vec sparse storage options, RRF analysis |
...
|--------|-----|------|------------|------|
| qdrant-client | github.com/qdrant/qdrant-client | Local mode API, QdrantLocal, deps | docs/qdrant-local-research.md | 2026-02-28 |
| Qdrant vectors docs | qdrant.tech/documentation/concepts/vectors | Named/sparse/multivectors | docs/qdrant-local-research.md | 2026-02-28 |
| Qdrant hybrid queries docs | qdrant.tech/documentation/concepts/hybrid-queries | Prefetch, RRF, DBSF | docs/qdrant-local-research.md | 2026-02-28 |
| Qdrant hybrid search article | qdrant.tech/articles/hybrid-search | ColBERT HNSW opt (m=0) | docs/qdrant-local-research.md | 2026-02-28 |
| bge-m3-qdrant-sample | github.com/yuniko-software/bge-m3-qdrant-sample | Full integration pattern | docs/qdrant-local-research.md | 2026-02-28 |
| workshop-ultimate-hybrid-search | github.com/qdrant/workshop-ultimate-hybrid-search | Evaluation workshop | docs/qdrant-local-research.md | 2026-02-28 |
