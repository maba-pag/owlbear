...
| OwlBear agent-framework-research | Local: `docs/research/agent-framework.md` | .95 | AgentDefinition format, registry design, delegation pattern |
| OwlBear agent-patterns-research | Local: `docs/research/agent-patterns.md` | .90 | Builder/validator team pattern, restricted tool sets per role |
