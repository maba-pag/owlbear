...
| 8 | OwlBear conversation-router.md | `docs/research/conversation-router.md` | 1.0 |
...
sub-agents. OwlBear researched this in `conversation-router.md` and chose prompt-based
