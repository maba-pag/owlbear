...
Research #234 (docs/graph-augmented-retrieval-research.md) established that pre-retrieval graph expansion (1-hop BFS, budget-capped) is the right approach for OwlBear. This follow-up addresses four open implementation questions:
...
|--------|-----|-----------|------|
| OwlBear graph-augmented-retrieval-research.md | docs/graph-augmented-retrieval-research.md | .95 | Prior art analysis, architecture selection, budget strategy |
