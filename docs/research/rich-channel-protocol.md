...
| OwlBear `docs/research/channel-protocol-extension.md` (#482) | Full analysis of 3 options with trade-off matrix; recommends widening ChannelPlugin | 1.0 |
...
**This task is a duplicate of #482.** The channel-protocol-extension research already analyzed all three options and recommended widening `ChannelPlugin` with `.85` confidence. The specific changes needed are documented in `docs/research/channel-protocol-extension.md` §5.
