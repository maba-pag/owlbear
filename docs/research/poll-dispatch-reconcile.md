...
| OwlBear symphony.md | `docs/research/symphony.md` (#584) | .95 |
| OwlBear orchestration-agent-frameworks.md | `docs/research/orchestration-agent-frameworks.md` (#580) | .95 |
| quoroom-ai/room (WIP continuity) | `docs/research/quoroom-room.md` (#588) | .80 |
