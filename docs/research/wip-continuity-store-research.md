...
|--------|-----|------|------------|------|
| quoroom-ai/room | <https://github.com/quoroom-ai/room/blob/main/src/shared/agent-loop.ts> | WIP save/load pattern, CONTINUE FORWARD prompt injection, auto-WIP fallback, momentum gap | `docs/wip-continuity-store-research.md` | 2026-03-07 |
| LangGraph durable execution | <https://docs.langchain.com/oss/python/langgraph/durable-execution> | Checkpoint persistence concept, thread-id keyed state, resume semantics | `docs/wip-continuity-store-research.md` | 2026-03-07 |
