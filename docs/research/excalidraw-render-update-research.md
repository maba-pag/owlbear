...
Task #629 proposes a Playwright-based `ExcalidrawRenderService` that renders Excalidraw JSON to PNG via `BrowserManager`. Prior research (docs/excalidraw-render-service-research.md) recommended deferring this as Tier 2 in favor of a Tier 0 Kroki passthrough. This update re-evaluates: should #629 proceed, or should the Kroki passthrough be created first?
