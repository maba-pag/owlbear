...
| OpenClaw skills research (OwlBear) | docs/openclaw-skills-research.md S3a | .90 |
| OpenClaw ecosystem research (OwlBear) | docs/openclaw-ecosystem-research.md S3a | .90 |
...
| Poll-dispatch-reconcile research (OwlBear) | docs/poll-dispatch-reconcile-research.md | .85 |
...
See docs/heartbeat-runner-research.md for full analysis.
