...
|---|--------|-----|-----------|
| S1 | nWave `StaleExecutionDetector` | docs/research/nwave.md §3.3 P4 | .80 — exact pattern: scan IN_PROGRESS, configurable threshold |
| S2 | Quoroom Room stuck detection | docs/research/quoroom-room.md §3.4 | .75 — progress-based: tracks productive tool calls per cycle |
| S3 | Symphony reconciliation | docs/research/symphony.md §3.2 | .80 — per-tick reconcile detects stalls |
