...
| OwlBear web-crawling-research | [docs/web-crawling-research.md](../docs/web-crawling-research.md) | .75 | Already recommended "SHA-256 of extracted text body — before ingestion — skip re-processing identical content" and "Check documents table by source URL metadata — cross-session" |
