...
Task #706 asks: how should OwlBear's `visual-output` skill be structured? The parent research (#592, `docs/research/visual-explainer.md`) established that `nicobailon/visual-explainer` (MIT) is the primary pattern to adopt. This document focuses on the specific **skill design**: what to include, what to cut, and how to adapt it for OwlBear's agent stack.
