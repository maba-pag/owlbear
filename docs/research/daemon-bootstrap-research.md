...
| OwlBear `pydantic-ai-integration-research.md` | `docs/pydantic-ai-integration-research.md` | .85 | Confirmed OpenAIProvider pattern, FunctionToolset, PydanticAI provides agent loop |
