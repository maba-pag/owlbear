...
| Prior research #264 | `docs/research/browser-automation.md` | .95 | Previous comparison — established "keep custom" for browser automation |
...
```
kanban\kanban-md.exe create "Close #277 with DEFER decision — update task body" --priority nice-to-have --tags "docs,phase-6" --body "Update #277 body with research outcome: DEFER. Link to docs/research/crawl4ai-evaluation.md. Move to done."
```
