...
| LangChain indexing API | (cited in content-hashing-research.md) | .80 | RecordManager, content+metadata hashing, cleanup modes (incremental/full) |
| Cognee (task pipeline) | (cited in knowledge-pipeline-research.md) | .75 | Source provenance tracking (source_pipeline, source_task fields) |
