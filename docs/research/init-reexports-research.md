...
```
kanban\kanban-md.exe create "Remove unused re-exports from core and knowledge __init__.py" --priority nice-to-have --tags "audit,architecture,scope:core" --description "owlbear.core exports 6 symbols, owlbear.memory.knowledge exports 35 symbols, but 0/66 consumers use them. Remove re-exports, keep docstrings. See docs/init-reexports-research.md §3.2."
```

```
kanban\kanban-md.exe edit 549 --description "RESOLVED: Do not add re-exports. See docs/init-reexports-research.md. Existing re-exports (core, knowledge) have 0 consumers across 66+ imports — 100% use deep paths. OwlBear is an application, not a library. KISS/YAGNI/DRY all favor deep imports. Follow-up: #TBD to remove unused core/knowledge re-exports."
```
