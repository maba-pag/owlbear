...
| OwlBear dual-embedding-rrf-research.md | docs/dual-embedding-rrf-research.md | .90 | Current dual-embedding + RRF recommendation (Option B: bge-small + SPLADE++) |
| OwlBear retrieve-rerank-research.md | docs/retrieve-rerank-research.md §3.6 | .85 | Failure mode analysis: cross-references, policy lookups — graph expansion directly addresses these |
| OwlBear knowledge-graph-research.md | docs/knowledge-graph-research.md | .80 | Current architecture: SQLite + sqlite-vec + FastEmbed; GraphStore entities/edges/documents |
...
|--------|-----|------|------------|------|
| Microsoft GraphRAG | microsoft.github.io/graphrag/query/local_search | Local Search entity expansion pattern, prioritized context filling | `docs/graph-augmented-retrieval-research.md` (prior art, architecture) | 2026-02-28 |
| neo4j-graphrag-python | github.com/neo4j/neo4j-graphrag-python | VectorCypherRetriever pattern (vector search → graph traversal) | `docs/graph-augmented-retrieval-research.md` (prior art) | 2026-02-28 |
| Neo4j blog — Graph Traversal GraphRAG | neo4j.com/developer-blog/graph-traversal-graphrag-python-package | Vector search + Cypher traversal integration pattern | `docs/graph-augmented-retrieval-research.md` (prior art) | 2026-02-28 |
| BGE-M3 paper (Chen et al. 2024) | arxiv.org/abs/2402.03216 | Multi-functionality embedding analysis (dense+sparse+ColBERT) | `docs/graph-augmented-retrieval-research.md` (bge-m3 analysis) | 2026-02-28 |
| BAAI/bge-m3 HuggingFace | huggingface.co/BAAI/bge-m3 | Model specs, FlagEmbedding usage, MIT license verification | `docs/graph-augmented-retrieval-research.md` (bge-m3 analysis) | 2026-02-28 |
| FastEmbed (Qdrant) | qdrant.github.io/fastembed/examples/Supported_Models | Confirmed bge-m3 not in supported models list | `docs/graph-augmented-retrieval-research.md` (feasibility) | 2026-02-28 |
| LightRAG (HKUDS) | github.com/HKUDS/LightRAG | Graph-augmented retrieval pattern with neighbor expansion | `docs/graph-augmented-retrieval-research.md` (prior art) | 2026-02-28 |
| nano-graphrag | github.com/gusye1234/nano-graphrag | Minimal GraphRAG implementation (~1100 LOC) | `docs/graph-augmented-retrieval-research.md` (prior art) | 2026-02-28 |
