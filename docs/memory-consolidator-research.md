...
| 7 | Bootstrap assembly research | `docs/bootstrap-assembly-research.md` §3.5 | 0.9 |
...
| 10 | EscalationHook research (precedent) | `docs/escalation-hook-research.md` | 0.8 |
| 11 | Architecture docs | `docs/architecture.md` L315-330, L472 | 0.9 |
| 12 | Nanobot two-layer memory | `docs/agent-patterns-research.md` §3.6 | 0.8 |
