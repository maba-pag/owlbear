...
|--------|-----|------|------------|------|
| BAAI/bge-m3 model card | huggingface.co/BAAI/bge-m3 | Usage examples, model specs, ONNX file listing | docs/bge-m3-integration-research.md | 2026-02-28 |
| FastEmbed supported models | qdrant.github.io/fastembed/examples/Supported_Models | Confirmed bge-m3 absent from all model lists | docs/bge-m3-integration-research.md | 2026-02-28 |
| FastEmbed issue #107 | github.com/qdrant/fastembed/issues/107 | NirantK quote on ONNX linear head requirement | docs/bge-m3-integration-research.md | 2026-02-28 |
| FastEmbed PR #602 | github.com/qdrant/fastembed/pull/602 | Dense-only PR status, Feb 2026 | docs/bge-m3-integration-research.md | 2026-02-28 |
| FlagEmbedding v1.3.5 source | github.com/FlagOpen/FlagEmbedding | M3Embedder code: FP16 CPU disable, sparse format, ColBERT format, dependencies | docs/bge-m3-integration-research.md | 2026-02-28 |
| yuniko-software/bge-m3-qdrant-sample | github.com/yuniko-software/bge-m3-qdrant-sample | Qdrant hybrid search integration pattern | docs/bge-m3-integration-research.md | 2026-02-28 |
