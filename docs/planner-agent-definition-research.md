...
| OwlBear knowledge-toolset-research.md | `docs/knowledge-toolset-research.md` | .85 | `KnowledgeToolset` — task #291, backlog, not yet implemented |
| OwlBear web-search-tool-research.md | `docs/web-search-tool-research.md` | .85 | `WebSearchToolset` — task #292, backlog, not yet implemented |
