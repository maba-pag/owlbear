...
| OwlBear prior research | docs/pydantic-ai-integration-research.md, docs/daemon-bootstrap-research.md | .90 | Confirmed patterns: loop-outside-agent, FunctionToolset, OpenAIProvider |
