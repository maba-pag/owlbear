...
| Knowledge ingestion research (#133) | docs/knowledge-ingestion-research.md | .95 | Pipeline architecture: intake → chunk → embed → extract → store. Defines the interface crawled content must feed into |
