...
**Builds on:** [daemon-bootstrap-research.md](daemon-bootstrap-research.md) (model bridge .90, procedural bootstrap .90, loop-outside-agent .90) and [agent-patterns-research.md](agent-patterns-research.md) (progressive skill loading, canonical Message, two-layer memory, hook-based safety).
...
| daemon-bootstrap-research.md | local | .95 | Model bridge, procedural bootstrap, loop-outside-agent recommendations |
| agent-patterns-research.md | local | .90 | Progressive loading, canonical Message, builder/validator, hook safety |
