...
|--------|-----|-----------|
| OpenAI Symphony SPEC.md | `docs/symphony-research.md` S3.2 (captured from GitHub) | .95 |
...
| OwlBear daemon-retry-reconciliation-research.md | `docs/daemon-retry-reconciliation-research.md` (#512) | .90 |
| OwlBear orchestration-agent-frameworks-research.md | `docs/orchestration-agent-frameworks-research.md` S3.2 | .85 |
| OwlBear poll-dispatch-reconcile-research.md | `docs/poll-dispatch-reconcile-research.md` (#614) | .90 |
