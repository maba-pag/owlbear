...
| OwlBear parent research #583 | `docs/workflow-dashboards-devtools-research.md` §3.4 | .90 | Rich is transitive dep (0 new deps), ~30 LOC for table replacement |
