...
| MCP servers running | Run `MCP: List Servers` from the Command Palette — owlbear-kanban should show `running` |
...
The `owlbear-kanban` server supports environment variables to customise its behaviour.
