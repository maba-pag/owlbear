...
| OwlBear bge-m3-integration-research | docs/research/bge-m3-integration.md | .90 | FP32 on CPU confirmed, RAM estimates, ColBERT output format, latency per chunk |
| OwlBear qdrant-local-features-research | docs/research/qdrant-local-features.md | .95 | Verified: multivector MAX_SIM, prefetch→rescore, and sparse all work in local mode |
| OwlBear retrieve-rerank-research | docs/research/retrieve-rerank.md | .85 | Current pipeline architecture, cross-encoder latency estimates (2-4s for 50 pairs) |
...
|--------|-----|------|------------|------|
| bge-m3 paper (Chen et al. 2024) | arxiv.org/abs/2402.03216 | MIRACL/MLDR/NarrativeQA benchmark tables for ColBERT reranking vs dense/sparse/hybrid | docs/research/colbert-vs-crossencoder.md | 2026-02-28 |
| BAAI/bge-reranker-v2-m3 | huggingface.co/BAAI/bge-reranker-v2-m3 | Cross-encoder specs, MIRACL reranking eval | docs/research/colbert-vs-crossencoder.md | 2026-02-28 |
| Qdrant hybrid search article | qdrant.tech/articles/hybrid-search/ | Prefetch→ColBERT rescore Query API pattern, HNSW disable tip | docs/research/colbert-vs-crossencoder.md | 2026-02-28 |
| Qdrant late-interaction article | qdrant.tech/articles/late-interaction-models/ | BEIR late-interaction benchmarks, quantization impact | docs/research/colbert-vs-crossencoder.md | 2026-02-28 |
| SBERT Retrieve & Re-Rank | sbert.net/examples/applications/retrieve_rerank/ | Cross-encoder > ColBERT > bi-encoder quality hierarchy | docs/research/colbert-vs-crossencoder.md | 2026-02-28 |
