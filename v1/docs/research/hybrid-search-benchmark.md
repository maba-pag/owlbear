...
| OwlBear qdrant-local-research | docs/research/qdrant-local.md | .85 | Current hybrid search implementation details |
| OwlBear colbert-vs-crossencoder-research | docs/research/colbert-vs-crossencoder.md | .85 | Quality comparison tables from bge-m3 paper |
...
|--------|-----|------|------------|------|
| BEIR benchmark | github.com/beir-cellar/beir | Standard IR benchmark with ground truth qrels | docs/research/hybrid-search-benchmark.md | 2026-03-01 |
| ranx | github.com/AmenRa/ranx | IR evaluation library (nDCG, MRR, precision, statistical tests) | docs/research/hybrid-search-benchmark.md | 2026-03-01 |
| Qdrant hybrid search workshop | github.com/qdrant/workshop-ultimate-hybrid-search | SciFact + ranx evaluation pattern | docs/research/hybrid-search-benchmark.md | 2026-03-01 |
| Qdrant hybrid search article | qdrant.tech/articles/hybrid-search/ | ranx + Qrels/Run evaluation methodology | docs/research/hybrid-search-benchmark.md | 2026-03-01 |
| NFCorpus (BEIR) | huggingface.co/datasets/BeIR/nfcorpus | 3.6K doc bio-medical IR dataset with multi-level relevance | docs/research/hybrid-search-benchmark.md | 2026-03-01 |
