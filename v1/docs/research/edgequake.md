...
| OwlBear community-detection.md | docs/research/community-detection.md | .85 | Prior OwlBear research: community detection is YAGNI at our scale |
| OwlBear graph-augmented-retrieval.md | docs/research/graph-augmented-retrieval.md | .85 | OwlBear's existing neighbor-expansion retriever |
