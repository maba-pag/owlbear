...
- Upper bound: ~10K entities (laptop daemon, see provenance-tracking.md)
- Design ceiling: <50K entities (see graph-augmented-retrieval.md §3.8)
- Per document: 8–60 unique entities (see intra-document-graph.md §3.4)
...
| OwlBear graph-augmented-retrieval.md | docs/research/graph-augmented-retrieval.md §3.1 | .90 | Rated community-based approach "Very High complexity", "Overkill" for OwlBear. Recommended pre-retrieval BFS instead. |
| OwlBear knowledge-pipeline.md §4 | docs/research/knowledge-pipeline.md | .85 | Origin of task #274. "Learn from GraphRAG: community detection for summarization." |
| OwlBear intra-document-graph.md | docs/research/intra-document-graph.md | .80 | Entity counts per document. Cost analysis for LLM calls on entity sets. |
...
The graph-augmented retrieval research (docs/research/graph-augmented-retrieval.md) compared four retrieval variants:
...
|--------|-----|------|------------|------|
| MS GraphRAG paper | arxiv.org/abs/2404.16130 | Community detection architecture, scale analysis, Leiden clustering pattern | docs/research/community-detection.md (scale comparison) | 2026-03-01 |
| leidenalg | pypi.org/project/leidenalg | GPL-3 license analysis, API surface for Leiden in Python | docs/research/community-detection.md (license blocker) | 2026-03-01 |
| python-igraph | pypi.org/project/igraph | GPL-2 license analysis, built-in community_leiden method | docs/research/community-detection.md (license blocker) | 2026-03-01 |
