...
| 8 | AutoGen event logging | `github.com/microsoft/autogen` | Prior art for self-improvement patterns (cited in `docs/research/agent-analytics.md`) |
