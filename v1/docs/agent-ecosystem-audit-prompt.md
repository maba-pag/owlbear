# Agent Ecosystem Audit & Remediation Prompt

> **Purpose:** Paste this prompt to start a comprehensive audit of the OwlBear agent
> ecosystem. It encodes the taxonomy, structural expectations, and verification
> criteria refined over multiple audit iterations. Reusable across agent/skill changes.
