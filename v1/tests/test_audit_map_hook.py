...
class TestFromAC_983_AuditMapWiringInBootstrap:
    ...
    def test_audit_map_hook_not_registered_when_ingest_pipeline_none(self, tmp_path: Path) -> None:
    ...
    def test_audit_map_hook_channel_is_none_when_channel_none_passed(self, tmp_path: Path) -> None:
    ...
    def test_audit_map_hook_shares_supervisor_with_retrospective_hook(self, tmp_path: Path) -> None:
...
""",
        ...
        advisory = (tmp_path / "docs" / "scratch" / "42-audit-map.md").read_text(encoding="utf-8")
