        ...
        if working_dir is None:
            ...
            try:
                ...
                self._emit_audit_event(
                    event_type="path_escape_blocked",
                    severity="high",
                    detail=f"Blocked working_dir outside workspace: {working_dir}",
    ...
    def _emit_audit_event(
        ...
        *,
        ...
        try:
            ...
            logger.debug("Security audit sink failed in TerminalToolset", exc_info=True)
